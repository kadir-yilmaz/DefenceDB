...
namespace DefenceDB.DAL.Migrations
{
    ...
    [Migration("20260704110958_AddArticleShowcase")]
    partial class AddArticleShowcase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsShowcase = false,
                            ModelTypeName = "DefenceDB.EL.Models.Products.AirSojAircraft",
                            Name = "Hava SOJ",
                            ParentCategoryId = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsShowcase = false,
                            ModelTypeName = "DefenceDB.EL.Models.Products.CargoAircraft",
                            Name = "Askeri Kargo",
                            ParentCategoryId = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsShowcase = false,
                            ModelTypeName = "DefenceDB.EL.Models.Products.MaritimePatrolAircraft",
                            Name = "Deniz Karakol",
                            ParentCategoryId = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsShowcase = false,
                            ModelTypeName = "DefenceDB.EL.Models.Products.AwacsAircraft",
                            Name = "AWACS",
                            ParentCategoryId = 2,
                            Slug = "awacs-ucaklari",
                            SortOrder = 0
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsShowcase = false,
                            ModelTypeName = "DefenceDB.EL.Models.Products.LandVehicle",
                            Name = "Tanklar",
                            ParentCategoryId = 22,
                            Slug = "tanklar",
                            SortOrder = 0
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.ProductReadModel", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SpecificPropertiesJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.AirSojAircraft", b =>
                {
                    b.HasBaseType("DefenceDB.EL.Models.DefenseProduct");
                    ...
                    b.Property<string>("JammerType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("MaxRangeKm")
                        .HasColumnType("float");

                    b.ToTable("AirSojAircrafts", (string)null);
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.AwacsAircraft", b =>
                {
                    b.HasBaseType("DefenceDB.EL.Models.DefenseProduct");

                    b.Property<double?>("DetectionRangeKm")
                        .HasColumnType("float");
                    ...
                    b.ToTable("AwacsAircrafts", (string)null);
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.CargoAircraft", b =>
                {
                    b.HasBaseType("DefenceDB.EL.Models.DefenseProduct");

                    b.Property<double?>("CargoVolumeCubicMeters")
                        .HasColumnType("float");

                    b.Property<double?>("PayloadCapacityTons")
                        .HasColumnType("float");

                    b.Property<double?>("RangeWithMaxPayloadKm")
                        .HasColumnType("float");

                    b.ToTable("CargoAircrafts", (string)null);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "A400M Atlas",
                            Slug = "a400m-atlas",
                            CargoVolumeCubicMeters = 340.0,
                            PayloadCapacityTons = 37.0,
                            RangeWithMaxPayloadKm = 3300.0
                        });
                });
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.LandVehicle", b =>
                {
                    b.HasBaseType("DefenceDB.EL.Models.DefenseProduct");
                    ...
                    b.ToTable("LandVehicles", (string)null);
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.MaritimePatrolAircraft", b =>
                {
                    b.HasBaseType("DefenceDB.EL.Models.DefenseProduct");
                    ...
                    b.Property<bool>("HasTorpedoTubes")
                        .HasColumnType("bit");

                    b.Property<string>("SonarType")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("MaritimePatrolAircrafts", (string)null);
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.AirSojAircraft", b =>
                {
                    b.HasOne("DefenceDB.EL.Models.DefenseProduct", null)
                        .WithOne()
                        .HasForeignKey("DefenceDB.EL.Models.Products.AirSojAircraft", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.AwacsAircraft", b =>
                {
                    b.HasOne("DefenceDB.EL.Models.DefenseProduct", null)
                        .WithOne()
                        .HasForeignKey("DefenceDB.EL.Models.Products.AwacsAircraft", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.CargoAircraft", b =>
                {
                    b.HasOne("DefenceDB.EL.Models.DefenseProduct", null)
                        .WithOne()
                        .HasForeignKey("DefenceDB.EL.Models.Products.CargoAircraft", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.LandVehicle", b =>
                {
                    b.HasOne("DefenceDB.EL.Models.DefenseProduct", null)
                        .WithOne()
                        .HasForeignKey("DefenceDB.EL.Models.Products.LandVehicle", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DefenceDB.EL.Models.Products.MaritimePatrolAircraft", b =>
                {
                    b.HasOne("DefenceDB.EL.Models.DefenseProduct", null)
                        .WithOne()
                        .HasForeignKey("DefenceDB.EL.Models.Products.MaritimePatrolAircraft", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
