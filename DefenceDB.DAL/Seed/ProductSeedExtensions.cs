...
public static class ProductSeedExtensions
{
    public static void SeedProducts(this ModelBuilder modelBuilder)
    {
        ...
        // ----------------------------------------------------
        // 9. ENGINES AND PROPULSION SYSTEMS (Motor ve Güç Sistemleri)
        // ----------------------------------------------------
        modelBuilder.Entity<TurbofanEngine>().HasData(
        ...
        modelBuilder.Entity<TurbojetEngine>().HasData(
        ...
        modelBuilder.Entity<TurboshaftEngine>().HasData(
        ...
        modelBuilder.Entity<TurbopropEngine>().HasData(
        ...
        modelBuilder.Entity<MarineGasTurbine>().HasData(
        ...
        modelBuilder.Entity<PistonEngine>().HasData(
        ...
        modelBuilder.Entity<RocketMotor>().HasData(
        ...
        modelBuilder.Entity<ElectricNuclearPower>().HasData(
